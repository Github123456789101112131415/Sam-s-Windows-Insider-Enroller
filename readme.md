Sam's Windows Insider Enroller
--------------------

### Description
Sam's Windows Insider Enroller is a simple Windows Command Prompt script to enable access
...
receiving Insider Preview builds` in Sam's Windows Insider Enroller. You will get prompted
